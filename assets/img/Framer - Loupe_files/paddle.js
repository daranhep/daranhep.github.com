...
var _Paddle = (function Paddle(_window, libraryVersion) {
	...
	return function PaddleConstruct(_window, libraryVersion) {
		...
		var _env = {
			...
			defaults: {
				local: {
					checkoutBase: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.local:8443/checkout/product/',
					internalCheckoutBase: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.local:8443/checkout/tool/',
					pricesApi: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.local:8443/api/1.0/prices',
					dataApi: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.local:8443/api/1.0/data',
					orderApi: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.local:8443/api/1.0/order',
					audienceApi: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.local:8443/api/1.0/audience/{vendor_id}/add',
					userHistoryApi: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.com:8443/api/2.0/user/history',
					analyticsKey: '8b03159305e2c0f49bf7481c073a4819',
					affiliateAnalyticsKey: '8be7b8d69526697e7ae22aff30d34603',
					consentMessageTranslationAPI: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.local:8443/ajax/consent-message'
				},
				dev: {
					checkoutBase: 'https://web.archive.org/web/20180830093621/https://dev-checkout.paddle.com/checkout/product/',
					internalCheckoutBase: 'https://web.archive.org/web/20180830093621/https://dev-checkout.paddle.com/checkout/tool/',
					pricesApi: 'https://web.archive.org/web/20180830093621/https://dev-checkout.paddle.com/api/1.0/prices',
					dataApi: 'https://web.archive.org/web/20180830093621/https://dev-checkout.paddle.com/api/1.0/data',
					orderApi: 'https://web.archive.org/web/20180830093621/https://dev-checkout.paddle.com/api/1.0/order',
					audienceApi: 'https://web.archive.org/web/20180830093621/https://dev-checkout.paddle.com/api/1.0/audience/{vendor_id}/add',
					userHistoryApi: 'https://web.archive.org/web/20180830093621/https://dev-checkout.paddle.com/api/2.0/user/history',
					analyticsKey: '8b03159305e2c0f49bf7481c073a4819',
					affiliateAnalyticsKey: '8be7b8d69526697e7ae22aff30d34603',
					consentMessageTranslationAPI: 'https://web.archive.org/web/20180830093621/https://dev-checkout.paddle.com/ajax/consent-message'
				},
				staging: {
					checkoutBase: 'https://web.archive.org/web/20180830093621/https://staging-checkout.paddle.com/checkout/product/',
					internalCheckoutBase: 'https://web.archive.org/web/20180830093621/https://staging-checkout.paddle.com/checkout/tool/',
					pricesApi: 'https://web.archive.org/web/20180830093621/https://staging-checkout.paddle.com/api/1.0/prices',
					dataApi: 'https://web.archive.org/web/20180830093621/https://staging-checkout.paddle.com/api/1.0/data',
					orderApi: 'https://web.archive.org/web/20180830093621/https://staging-checkout.paddle.com/api/1.0/order',
					audienceApi: 'https://web.archive.org/web/20180830093621/https://staging-checkout.paddle.com/api/1.0/audience/{vendor_id}/add',
					userHistoryApi: 'https://web.archive.org/web/20180830093621/https://staging-checkout.paddle.com/api/2.0/user/history',
					analyticsKey: '8b03159305e2c0f49bf7481c073a4819',
					affiliateAnalyticsKey: '8be7b8d69526697e7ae22aff30d34603',
					consentMessageTranslationAPI: 'https://web.archive.org/web/20180830093621/https://staging-checkout.paddle.com/ajax/consent-message'
				},
				production: {
					checkoutBase: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.com/checkout/product/',
					internalCheckoutBase: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.com/checkout/tool/',
					pricesApi: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.com/api/1.0/prices',
					dataApi: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.com/api/1.0/data',
					orderApi: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.com/api/1.0/order',
					audienceApi: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.com/api/1.0/audience/{vendor_id}/add',
					userHistoryApi: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.com/api/2.0/user/history',
					analyticsKey: '3cca81641d7d36dd0223d8a5615ae36a',
					affiliateAnalyticsKey: '05150e015258048ddbc1aa7188718750',
					consentMessageTranslationAPI: 'https://web.archive.org/web/20180830093621/https://checkout.paddle.com/ajax/consent-message'
				}
			}
		};
		...
		var _defaults = {
			...
			paddleCssFile: 'https://web.archive.org/web/20180830093621/https://cdn.paddle.com/paddle/assets/css/paddle.css',
			animationCssFile: 'https://web.archive.org/web/20180830093621/https://cdn.paddle.com/paddle/assets/css/animate.css',
			popupWindow: {
				width: 370,
				height: 470,
				location: 'yes',
			...
			DetailsPopup: function(checkoutHash, processingMessage) {
				...
				var popupHtml = '<div class="paddle-popup paddle-animated paddle-bounceIn">';
					...
					popupHtml += '<div class="paddle-popup-close paddle-inset-close">';
						popupHtml += '<a class="paddle-popup-close-image" href="javascript:;"><img src="https://web.archive.org/web/20180830093621/https://cdn.paddle.com/paddle/assets/images/close-dark.png" border="0" /></a>';
					popupHtml += '</div>';
					...
					popupHtml += '<div class="paddle-popup-inner paddle-no-padding" style="background-color: #FFFFFF !important;">';
						popupHtml += '<div class="paddle-popup-order-loading paddle-popup-order-loading_'+popupId+'">';
							popupHtml += '<div class="paddle-popup-order-spinner"><img src="https://web.archive.org/web/20180830093621/https://cdn.paddle.com/paddle/assets/images/loading.gif" style="width: 50px; height: 50px;" /></div>';
		...
		this.Download = {
			...
			GetURLFromID: function(product_id) {
				if(typeof product_id != 'undefined' && product_id != '') {
					return 'https://web.archive.org/web/20180830093621/https://vendors.paddle.com/download/product/'+product_id;
				} else {
					return false;
				}
			},
				...
				var popupHtml = '<div class="paddle-popup paddle-animated paddle-'+attributes.view.animations.show+'" aria-busy="true">';
					...
					if(attributes.allowDismiss) {
						popupHtml += '<div class="paddle-popup-close">';
							popupHtml += '<a class="paddle-popup-close-image" href="#!"><img src="https://web.archive.org/web/20180830093621/https://cdn.paddle.com/paddle/assets/images/close-'+attributes.dismissColor+'.png" border="0" /></a>';
						popupHtml += '</div>';
					}
			...
			track: function(action, eventParams, definedParams, blocking) {
				...
				if(_options.enableTracking) {
					...
					if(_this.Status.loadedAnalytics && !_this.Status.failedLoadingAnalytics) {
						...
						//		_util.jsonp('https://web.archive.org/web/20180830093621/https://relay.getbeacon.io/server.php?action='+action+'&message='+JSON.stringify(properties), function(data) {
						//			// Do nothing...
						//		});
						//	}
		...
		var _util = {
			...
			showLoading: function(returnHtml) {
				...
				loadingImage.src = 'https://web.archive.org/web/20180830093621/https://cdn.paddle.com/paddle/assets/images/loading.gif';
			...
			buildCheckoutUrl: function(productId, checkoutQuery, type) {
				...
				if(checkoutQuery.internal == 'true') {
					...
					if(_util.isAffiliate() && (typeof checkoutQuery.override == 'undefined' || checkoutQuery.override.length == 0)) {
						...
						var checkoutFullUrl = 'https://web.archive.org/web/20180830093621/https://a.paddle.com/checkout/'+_util.affiliateToken()+'/?type=product&product_id='+productId+'&'+_util.queryString(checkoutQuery);
...
(function() {
	var Paddle;
	var PaddleVersion = "1.9.31"; // Increment this upon new Paddle.js version.
...
/*
     FILE ARCHIVED ON 09:36:21 Aug 30, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 21:05:01 Dec 06, 2018.
...
/*
playback timings (ms):
  LoadShardBlock: 46.175 (3)
  esindex: 0.007
  captures_list: 86.275
  CDXLines.iter: 14.612 (3)
  PetaboxLoader3.datanode: 140.003 (5)
  exclusion.robots: 0.135
  exclusion.robots.policy: 0.126
  RedisCDXSource: 0.442
  PetaboxLoader3.resolve: 114.316 (3)
  load_resource: 316.663
*/