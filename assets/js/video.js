  ...
  ((function($, t) {
    var e = {
      ...
      init: function(t) {
        ...
        t.originalEvent.origin.match(/vimeo/g) &&
          ...
          (a =
            "string" === $.type(t.originalEvent.data)
              ? $.parseJSON(t.originalEvent.data)
              : t.originalEvent.data) &&
          ((e = this.setPlayerID(a)),
          e.length &&
            ((i = this.setVimeoAPIurl(e)),
            a.hasOwnProperty("event") && this.handleEvent(a, e, i),
            a.hasOwnProperty("method") && this.handleMethod(a, e, i)));
      },
      setPlayerID: function(t) {
        return $("iframe[src*=" + t.player_id + "]");
      },
      setVimeoAPIurl: function(t) {
        return "http" !== t.attr("src").substr(0, 4)
          ? "https:" + t.attr("src").split("?")[0]
          : t.attr("src").split("?")[0];
      },
        ...
        switch (t.event.toLowerCase()) {
          case "ready":
            ...
            if (e.data("vimeoAPICall")) {
              for (var n = e.data("vimeoAPICall"), s = 0; s < n.length; s++)
                e[0].contentWindow.postMessage(
                  JSON.stringify(n[s].message),
                  n[s].api
                );
    ...
    jQuery(document).ready(function() {
      ...
      ($.vimeo = function(i, a, n) {
        ...
        if (
          ("string" == typeof a && (s.method = a),
          void 0 !== typeof n && "function" != typeof n && (s.value = n),
          "iframe" === i.prop("tagName").toLowerCase() &&
            s.hasOwnProperty("method"))
        )
          if (i.data("vimeoReady"))
        ...
        return (
          ("get" !== a.toString().substr(0, 3) && "paused" !== a.toString()) ||
            "function" != typeof n ||
            (!(function(i, a, n) {
              var s = t.setInterval(function() {
                e.catchMethods.methodreturn.length != i &&
                  (t.clearInterval(s), a(e.catchMethods.methodreturn[n]));
              }, 10);
            })(o, n, e.catchMethods.count),
...
+(function($) {
  ...
  (function($) {
    ...
    function t(t, i) {
      return this.each(function() {
        ...
        n || a.data("bs.modal", (n = new e(this, s))),
          "string" == typeof t ? n[t](i) : s.show && n.show(i);
      });
    }
    var e = function(t, e) {
      (this.options = e),
  ...
  (function($) {
    ...
    function e(t) {
      return this.each(function() {
        ...
        !a && n.toggle && /show|hide/.test(t) && (n.toggle = !1),
          a || e.data("bs.collapse", (a = new i(this, n))),
          "string" == typeof t && a[t]();
      });
    }
    var i = function(t, e) {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
          ...
          if (
            ...
            if ((this.$element.trigger(n), !n.isDefaultPrevented())) {
              a &&
                a.length &&
                (e.call(a, "hide"), t || a.data("bs.collapse", null));
              ...
              this.$element
                .one("bsTransitionEnd", $.proxy(o, this))
      ...
      (i.prototype.hide = function() {
        if (!this.transitioning && this.$element.hasClass("in")) {
          ...
          if ((this.$element.trigger(t), !t.isDefaultPrevented())) {
            ...
            this.$element[e](0)
              .one("bsTransitionEnd", $.proxy(a, this))
              .emulateTransitionEnd(i.TRANSITION_DURATION);
          }
        }
      }),
  ...
  $("#schedule").on("show.bs.modal", function(t) {
    $("#load-calendly").is(":empty") &&
      $("#load-calendly").html(
        "<div class='calendly-inline-widget' data-url='https://calendly.com/karpman/everchron-demo'></div><script type='text/javascript' src='https://calendly.com/assets/external/widget.js'></script>"
      );
  }),
  $(".start-video").click(function() {
    ...
    var t = $(this).data("video"),
      e =
        "<iframe id='video' src='https://player.vimeo.com/video/" +
        t +
        "?api=1&color=ffffff&title=0&byline=0&portrait=0&player_id=vimeoplayer' width='960' height='540' frameborder='0' webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>";
    $("#video-frame").is(":empty")
      ? ($("#video-frame").append(e),
        $("#video-modal").modal("show"),
        $("#video").vimeo("play"))
      : ($("#video-modal").modal("show"), $("#video").vimeo("play"));
  }),
  ...
  (function($) {
    var t = $(window),
      e = $(".main-footer");
    t.resize(function i() {
      if (t.width() < 575) return e.addClass("mobile-footer");
...
!1 === version ||
  (version >= 12 ? $("body").addClass("ie-edge") : $("body").addClass("ie")),
