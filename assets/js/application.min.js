...
function home() {
  function t() {
    $("#line-web").addClass("animate"),
      ...
      setTimeout(function() {
        $("#line-mobile").addClass("animate"), $("#blob-2").addClass("animate");
      }, 1e3),
      setTimeout(function() {
        $("#line-dev").addClass("animate"), $("#blob-3").addClass("animate");
      }, 1800);
  }
  ...
  return (function(t) {
    ...
    function(t, e) {
      function n() {
        u &&
          h &&
          ((u = !1), h.length ? (c = h.concat(c)) : (d = -1), c.length && i());
      }
      ...
      var i = n(5),
        ...
        c = {
          ...
          load: function(t) {
            ...
            return (
              (o = this.Cache.get(t)),
              o || ((o = i.xhr(t)), this.Cache.set(t, o)),
              o.then(
                function(t) {
...
var Util = (function($) {
    ...
    function n(t) {
      var e = this,
        n = !1;
      return (
        $(this).one(a.TRANSITION_END, function() {
          n = !0;
        }),
        setTimeout(function() {
  ...
  ScrollSpy = (function($) {
      ...
      d = (function() {
        ...
        return (
              ...
              [].slice
                ...
                .map(function(t) {
                  ...
                  if ((n && (e = document.querySelector(n)), e)) {
                    ...
                    if (r.width || r.height) return [$(e)[i]().top + o, n];
                  }
                  return null;
                })
                .filter(function(t) {
          ...
          (o._getConfig = function e(n) {
            if (
              ((n = _objectSpread({}, s, "object" == typeof n && n ? n : {})),
              "string" != typeof n.target)
            ) {
              var i = $(n.target).attr("id");
              i || ((i = Util.getUID(t)), $(n.target).attr("id", i)),
                (n.target = "#" + i);
            }
          ...
          (e._jQueryInterface = function t(i) {
            return this.each(function() {
              var t = $(this).data(n),
                o = "object" == typeof i && i;
              if (
                (t || ((t = new e(this, o)), $(this).data(n, t)),
                "string" == typeof i)
              ) {
                if (void 0 === t[i])
    ...
    return (
      $(window).on(l.LOAD_DATA_API, function() {
        for (
      ...
      ($.fn[t].noConflict = function() {
        return ($.fn[t] = r), d._jQueryInterface;
      }),
      d
    );
  })($),
  Carousel = (function($) {
      ...
      m = (function() {
        ...
        return (
          ...
          (o.pause = function t(e) {
            e || (this._isPaused = !0),
              $(this._element).find(p.NEXT_PREV)[0] &&
                (Util.triggerTransitionEnd(this._element), this.cycle(!0)),
          ...
          (o._getConfig = function e(n) {
            return (
              (n = _objectSpread({}, c, n)), Util.typeCheckConfig(t, n, u), n
            );
          }),
          (o._addEventListeners = function t() {
            var e = this;
            this._config.keyboard &&
              $(this._element).on(d.KEYDOWN, function(t) {
                return e._keydown(t);
              }),
              "hover" === this._config.pause &&
                ...
                "ontouchstart" in document.documentElement &&
                  $(this._element).on(d.TOUCHEND, function() {
                    e.pause(),
          ...
          (o._slide = function t(e, n) {
            ...
            if (
              (e === h.NEXT
                ? ((c = f.LEFT), (u = f.NEXT), (m = h.LEFT))
                : ((c = f.RIGHT), (u = f.PREV), (m = h.RIGHT)),
          ...
          (e._jQueryInterface = function t(i) {
            return this.each(function() {
              ...
              if (
                ...
                t[r]();
              } else o.interval && (t.pause(), t.cycle());
            });
          }),
    ...
    return (
      $(document).on(d.CLICK_DATA_API, p.DATA_SLIDE, m._dataApiClickHandler),
      ...
      ($.fn[t].Constructor = m),
      ($.fn[t].noConflict = function() {
        return ($.fn[t] = r), m._jQueryInterface;
      }),
      m
    );
  })($),
...
!(function(t) {
  ...
  return (
    ($.fn.tilt = function(t) {
      var e = function t() {
          this.ticking ||
            (requestAnimationFrame(c.bind(this)), (this.ticking = !0));
        },
        n = function t() {
          var e = this;
          $(this).on("mousemove", s),
        ...
        s = function t(n) {
          (this.mousePositions = r(n)), e.call(this);
        },
        a = function t() {
          i.call(this),
            (this.reset = !0),
      ...
      return (
        ...
        ($.fn.tilt.getValues = function() {
          ...
          return (
            $(this).each(function() {
              (this.mousePositions = r.call(this)), t.push(l.call(this));
            }),
            t
          );
        }),
    ...
    if (n.getElementsByClassName) {
      var i,
        ...
        I = (function() {
          var t,
            ...
            s = function() {
              var n = r;
              for (r = i.length ? o : i, t = !0, e = !1; n.length; )
                n.shift()();
              t = !1;
            },
            a = function(i, o) {
      ...
      var P = (function() {
          var t,
            ...
            Y = function(t, e) {
              var i,
                o = t,
                s =
                  "hidden" == E(n.body, "visibility") ||
                  "hidden" != E(t, "visibility");
              for (
                P -= e, L += e, k -= e, j += e;
                s && (o = o.offsetParent) && o != n.body && o != r;
                    ...
                    if (B)
                      if (
                        ...
                        (L = l.bottom) >= p &&
                          ...
                          (k = l.left) <= g &&
                          (L || j || k || P) &&
                          (o.loadHidden || "hidden" != E(y[s], "visibility")) &&
                          ((a && W < 3 && !m && (f < 3 || U < 4)) ||
                            Y(y[s], d)))
                      ) {
                        if ((nt(y[s]), (h = !0), W > 9)) break;
                      } else
                        !h &&
                          a &&
                          !u &&
            ...
            et = A(function(t, e, n, i, r) {
              var s, a, l, u, f, m;
              (f = T(t, "lazybeforeunveil", e)).defaultPrevented ||
                (i && (n ? w(t, o.autosizesClass) : t.setAttribute("sizes", i)),
                (a = t[c](o.srcsetAttr)),
                (s = t[c](o.srcAttr)),
                r && ((l = t.parentNode), (u = l && p.test(l.nodeName || ""))),
                ...
                a
                  ...
                  : s && !u && (z.test(t.nodeName) ? J(t, s) : (t.src = s)),
                r &&
                  (a || u) &&
                  C(t, {
                    src: s
            ...
            it = function() {
              if (!a) {
                if (s.now() - m < 999) return void h(it, 999);
                var t = O(function() {
                  (o.loadMode = 3), G();
                });
                (a = !0),
            ...
            _: function() {
              (m = s.now()),
                ...
                /d$|^c/.test(n.readyState)
                  ? it()
                  : (u("load", it), n[l]("DOMContentLoaded", G), h(it, 2e4)),
                i.elements.length ? (K(), I._lsFlush()) : G();
            },
            checkElems: G,
            unveil: nt
          };
        ...
        D = (function() {
          ...
          return {
            _: function() {
              (t = n.getElementsByClassName(o.autosizesClass)), u("resize", s);
            },
            checkElems: s,
            updateElem: i
          };
    ...
    return (
      ...
      (o.prototype = {
        ...
        init: function() {
          if (o.cutsTheMustard)
            return (
              (this.debouncer = new t(this.update.bind(this))),
      ...
      (($.fn.headroom = function(t) {
        return this.each(function() {
          ...
          (i = $.extend(!0, {}, Headroom.options, i)),
            n || ((n = new Headroom(this, i)), n.init(), e.data("headroom", n)),
            "string" == typeof t &&
              (n[t](), "destroy" === t && e.removeData("headroom"));
        });
      }),
  ...
  (function($) {
    ...
    function e(t, e) {
      var n = {};
      for (var i in t) i in e && ((n[i] = t[i]), delete t[i]);
      return n;
    }
    ...
    (t.prototype = {
      ...
      setup: function(t, e) {
        ...
        return (
          (n.$instance = o.clone().addClass(n.variant)),
          n.$instance.on(n.closeTrigger + "." + n.namespace, function(t) {
            var e = $(t.target);
            (("background" === n.closeOnClick && e.is("." + n.namespace)) ||
      ...
      getContent: function() {
        ...
        var t = this,
          ...
          r = e[t.type];
        if (
          (!r && o in e && ((r = e[o]), (o = t.target && i)),
          (o = o || n("href") || ""),
          !r)
        )
          for (var s in e) t[s] && ((r = e[s]), (o = t[s]));
        if (!r) {
          var a = o;
          if (
            ((o = null),
      ...
      setContent: function(t) {
        var e = this;
        return (
          t.is("iframe") && e.$instance.addClass(e.namespace + "-iframe"),
          e.$instance.removeClass(e.namespace + "-loading"),
          e.$instance
            .find("." + e.namespace + "-inner")
            .not(t)
            .slice(1)
            .remove()
            .end()
            .replaceWith($.contains(e.$instance[0], t[0]) ? "" : t),
      ...
      open: function(t) {
        var e = this;
        if (
          (e.$instance.hide().appendTo(e.root),
          ...
          if (n)
            return (
              ...
              $.when(n)
                .always(function(n) {
                  e.setContent(n), e.afterContent(t);
                })
                .then(e.$instance.promise())
                .done(function() {
                  e.afterOpen(t);
                })
            );
          ...
          !1 === e.beforeClose(t)
            ...
            : (0 === o(e).length && l(!1),
              e.$instance.fadeOut(e.closeSpeed, function() {
                e.$instance.detach(), e.afterClose(t), n.resolve();
              })),
          n.promise()
        );
      },
      resize: function(t, e) {
        if (t && e) {
          ...
          var n = Math.max(
            t / (parseInt(this.$content.parent().css("width"), 10) - 1),
            e / (parseInt(this.$content.parent().css("height"), 10) - 1)
          );
          n > 1 &&
            ((n = e / Math.floor(e / n)),
            this.$content
      ...
      chainCallbacks: function(t) {
        for (var e in t) this[e] = $.proxy(t[e], this, $.proxy(this[e], this));
      }
    }),
      $.extend(t, {
        id: 0,
            ...
            a = function(o) {
              var a = $(o.currentTarget),
                l = $.extend(
                  ...
                  i.readElementConfig(t[0], r.namespace),
                  i.readElementConfig(o.currentTarget, r.namespace),
                  n
                ),
                c = s || a.data("featherlight-persisted") || new i(e, l);
              "shared" === c.persist
                ? (s = c)
                : !1 !== c.persist && a.data("featherlight-persisted", c),
                l.$currentTarget.blur && l.$currentTarget.blur(),
                c.open(o);
            };
          return t.on(r.openTrigger + "." + r.namespace, r.filter, a), a;
        },
        current: function() {
          var t = this.opened();
        ...
        _callbackChain: {
          onKeyUp: function(t, e) {
            return 27 === e.keyCode
              ? (this.closeOnEsc && $.featherlight.close(e), !1)
              : t(e);
          },
          beforeOpen: function(t, e) {
            return (
              ...
              (this._$previouslyWithTabIndex = $("[tabindex]").not(
                '[tabindex="-1"]'
              )),
  ...
  (function($) {
    function t(e, n) {
      ...
      $.featherlight.apply(this, arguments), this.chainCallbacks(s);
    }
    var e = function(t) {
        window.console &&
          window.console.warn &&
          window.console.warn("FeatherlightGallery: " + t);
      },
      n =
    ...
    var s = {
      ...
      onKeyUp: function(t, e) {
        ...
        return n ? (this.$instance.trigger(n), !1) : t(e);
      }
    };
      ...
      $.extend(t.prototype, {
        ...
        navigateTo: function(t) {
          ...
          return (
            ...
            e.beforeContent(),
            $.when(e.getContent(), o.fadeTo(e.galleryFadeOut, 0)).always(
              function(t) {
                t.css("opacity", 0),
                  e.setContent(t),
                  e.afterContent(),
...
var articleView = Barba.BaseView.extend({
  ...
  onEnterCompleted: function() {
    article(),
      $("#disqus_thread").length &&
        addScript(
          "inject",
          "var disqus_config=function(){this.page.url=$('#disqus_thread').attr('data-url')};!function(){var t=document,e=t.createElement('script');e.src='https://ivomynttinendesign.disqus.com/embed.js',e.setAttribute('data-timestamp',+new Date),(t.head||t.body).appendChild(e)}();"
        );
  }
});
articleView.init();
      ...
      e.animate(
        ...
        function() {
          t.done(),
            $(".barba-layer").remove(),
            $("body").append(
              '<div class="barba-layer" style="transform:translateY(100%)"></div>'
            );
        }
      );
  }
